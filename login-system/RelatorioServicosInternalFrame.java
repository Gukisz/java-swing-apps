...
public class RelatorioServicosInternalFrame extends JPanel implements Printable {
    ...
    public RelatorioServicosInternalFrame() {
    ...
    private JPanel createPreviewPanel() {
        ...
        panel.setBackground(BG);
        panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(ACCENT), "Relatorio de Servicos",
    ...
    private void generateReport() {
        ...
        html.append(buildHtmlHeader("Relatorio de Servicos", list.size()));
        ...
        html.append("<th style='padding:10px; border:1px solid #646464; text-align:left;'>Descricao</th>");
        html.append("<th style='padding:10px; border:1px solid #646464; text-align:left;'>Preco</th>");
        html.append("</tr>");
        for (Service s : list) {
            html.append("<tr style='background:#1E1E1E;'>");
            html.append("<td style='padding:8px; border:1px solid #646464;'>").append(s.getId()).append("</td>");
            html.append("<td style='padding:8px; border:1px solid #646464;'>").append(escape(s.getName())).append("</td>");
            html.append("<td style='padding:8px; border:1px solid #646464;'>").append(escape(s.getDescription())).append("</td>");
            html.append("<td style='padding:8px; border:1px solid #646464;'>R$ ").append(String.format("%.2f", s.getPrice())).append("</td>");
            html.append("</tr>");
        }
    ...
    private void saveHtml() {
        ...
        String filename = "relatorio_servicos_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")) + ".html";
