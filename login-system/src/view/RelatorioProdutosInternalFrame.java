...
public class RelatorioProdutosInternalFrame extends JPanel implements Printable {
    ...
    public RelatorioProdutosInternalFrame() {
    ...
    private JPanel createPreviewPanel() {
        ...
        panel.setBackground(BG);
        panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(ACCENT), "Relatorio de Produtos",
    ...
    private void generateReport() {
        ...
        html.append(buildHtmlHeader("Relatorio de Produtos", list.size()));
    ...
    private void saveHtml() {
        ...
        String filename = "relatorio_produtos_" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")) + ".html";
